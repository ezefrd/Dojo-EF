 ...
 */
class StoredAddressDataGeneratorMLA  extends AbstractStoredAddressDataGenerator implements StoredAddressDataGenerator{
    ...
    Map buildAddressMap(AddressBO addressBO) {
        return [
                ...
                additional_info: addressBO.internalNumber?:""
        ]
    }
}
